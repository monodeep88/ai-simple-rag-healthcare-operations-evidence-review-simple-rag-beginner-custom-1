DOMAIN_SUMMARY = 'A practical Healthcare Operations Evidence Review Simple RAG - Beginner Custom 1 assistant tailored for Simple RAG workflows.'
USER_PERSONA = 'Operations user who needs source-grounded answers, checklists, and clear next actions.'
STARTER_QUESTIONS = ['What should I know first about Healthcare Operations Evidence Review Simple RAG - Beginner Custom 1?', 'What policy or evidence supports the recommended next step?', 'Create a checklist for handling this request.']
